...
export const SQUAD = [
  {name:"O. Marmoush", pos:"ST", e:"🇪🇬", apps:0, g:0, con:"LOAN 2027", wc:null, st:"NO.22 — LOAN WITH OBLIGATION", sc:"cyan"},
  // GOALKEEPERS
  {name:"A. Kinsky",      pos:"GK",e:"🇨🇿",apps:1, g:0,con:"2031+1",wc:null,   st:"NO.1 — NEW 5YR DEAL",  sc:"green"},
  ...
  // DEFENDERS
  {name:"JP van Hecke",   pos:"CB",e:"🇳🇱",apps:1, g:0,con:"2031",  wc:"NED",  st:"NEW — €52m 5YR",       sc:"cyan"},
  ...
  {name:"D. Udogie",      pos:"LB",e:"🇮🇹",apps:1, g:0,con:"2030",  wc:null,   st:"AVAILABLE MD1",          sc:"green"},
  {name:"A. Robertson",   pos:"LB",e:"🏴󠁧󠁢󠁳󠁣󠁴󠁿",apps:1, g:0,con:"TBC",   wc:null,   st:"NEW — FREE",           sc:"cyan"},
  ...
  // MIDFIELDERS
  {name:"A. Gray",        pos:"CM",e:"🏴󠁧󠁢󠁥󠁮󠁧󠁿",apps:1, g:0,con:"2030",  wc:null,   st:"CORE (also covers DM/RB)",sc:"green"},
  {name:"L. Bergvall",    pos:"CM",e:"🇸🇪",apps:1, g:0,con:"2031",  wc:null,   st:"REQUESTED — FOREST BID REJ.",sc:"red"},
  {name:"C. Gallagher",   pos:"CM",e:"🏴󠁧󠁢󠁥󠁮󠁧󠁿",apps:1, g:0,con:"2031",  wc:null,   st:"CORE",                 sc:"green"},
  {name:"R. Bentancur",   pos:"DM",e:"🇺🇾",apps:1, g:0,con:"2029",  wc:"URU",  st:"NEW CONTRACT — SIGNED OCT '25, STAYS (also covers CM)",sc:"green"},
  {name:"S. Tonali",      pos:"DM",e:"🇮🇹",apps:1, g:0,con:"TBC",   wc:null,   st:"NEW — £100m RECORD, 6YR (reported)", sc:"cyan"},
  {name:"J. Maddison",    pos:"AM",e:"🏴󠁧󠁢󠁥󠁮󠁧󠁿",apps:1, g:0,con:"2028",  wc:null,   st:"AVAILABLE MD1",          sc:"green"},
  {name:"X. Simons",      pos:"AM",e:"🇳🇱",apps:0, g:0,con:"2030",  wc:null,   st:"ACL — FEB 2027",       sc:"red"},
  {name:"M. Fernandes",   pos:"AM",e:"🇵🇹",apps:1, g:0,con:"TBC",   wc:null,   st:"NEW — AVAILABLE MD1",    sc:"cyan"},
  // FORWARDS
  ...
  {name:"M. Tel",         pos:"LW",e:"🇫🇷",apps:1, g:0,con:"2031",  wc:null,   st:"PERMANENT — CORE (£30m, signed Jun '25)",sc:"green"},
  {name:"W. Odobert",     pos:"LW",e:"🇫🇷",apps:0, g:0,con:"2029",  wc:null,   st:"ACL — NOV 2026 (return needs re-check)",sc:"red"},
  {name:"D. Solanke",     pos:"ST",e:"🏴󠁧󠁢󠁥󠁮󠁧󠁿",apps:1, g:0,con:"2030",  wc:null,   st:"AVAILABLE MD1",          sc:"green"},
...
export const INJURIES = [
  ...
  {name:"Pape Matar Sarr", flag:"SN",emoji:"🇸🇳",pos:"CM",issue:"football.london injury round-up lists Sarr ahead of Newcastle — consistent with existing INJURIES entry (hamstring). Return date described as 'not serious' previously; confirm whether he is available for Newcastle or still out.",          sev:"short",ret:"TBC — flagged for human review, previously 'after 22 Aug'"},
