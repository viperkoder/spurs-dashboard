...
export const SQUAD = [
  {name:"T. Adarabioyo", pos:"CB", e:"🏴󠁧󠁢󠁥󠁮󠁧󠁿", apps:2, g:0, con:"TBC", wc:null, st:"NO.4 — SIGNED FROM CHELSEA", sc:"cyan"},
  {name:"M. Mudryk", pos:"LW", e:"🇺🇦", apps:1, g:0, con:"LOAN 2027", wc:null, st:"SEASON-LONG LOAN — OPTION TO BUY", sc:"cyan"},
  {name:"Savio", pos:"RW", e:"🇧🇷", apps:4, g:1, con:"TBC", wc:null, st:"NEW — SIGNED FROM MAN CITY", sc:"cyan"},
  {name:"O. Marmoush", pos:"ST", e:"🇪🇬", apps:4, g:0, con:"LOAN 2027", wc:null, st:"NO.22 — LOAN WITH OBLIGATION", sc:"cyan"},
  // GOALKEEPERS
  {name:"A. Kinsky",      pos:"GK",e:"🇨🇿",apps:5, g:0,con:"2031+1",wc:null,   st:"NO.1 — NEW 5YR DEAL",  sc:"green"},
  {name:"M. Dubravka",    pos:"GK",e:"🇸🇰",apps:1, g:0,con:"TBC",   wc:null,   st:"NEW — joins Jul 1",    sc:"cyan"},
  {name:"B. Austin",      pos:"GK",e:"🏴󠁧󠁢󠁥󠁮󠁧󠁿",apps:0, g:0,con:"TBC",   wc:null,   st:"NO.3 — BACKUP",         sc:"muted"},
  // DEFENDERS
  {name:"JP van Hecke",   pos:"CB",e:"🇳🇱",apps:5, g:0,con:"2031",  wc:"NED",  st:"NEW — €52m 5YR",       sc:"cyan"},
  {name:"M. Senesi",      pos:"CB",e:"🇦🇷",apps:2, g:0,con:"2030",  wc:null,   st:"NEW — FREE",           sc:"cyan"},
  {name:"M. van de Ven",  pos:"CB",e:"🇳🇱",apps:4, g:0,con:"2029",  wc:"NED",  st:"CAPTAIN — AVAILABLE",sc:"amber"},
  {name:"P. Porro",       pos:"RB",e:"🇪🇸",apps:3, g:0,con:"2030",  wc:"ESP",  st:"AVAILABLE FOR VILLA — CONFIRMED 16 SEP",sc:"amber"},
  {name:"D. Udogie",      pos:"LB",e:"🇮🇹",apps:5, g:0,con:"2030",  wc:null,   st:"AVAILABLE MD1",          sc:"green"},
  {name:"A. Robertson",   pos:"LB",e:"🏴󠁧󠁢󠁳󠁣󠁴󠁿",apps:5, g:0,con:"TBC",   wc:null,   st:"NEW — FREE",           sc:"cyan"},
  {name:"B. Davies",      pos:"LB",e:"🏴󠁧󠁢󠁷󠁬󠁳󠁿",apps:1, g:1,con:"2027",  wc:null,   st:"RENEWED JUN 10",       sc:"green"},
  // MIDFIELDERS
  {name:"A. Gray",        pos:"CM",e:"🏴󠁧󠁢󠁥󠁮󠁧󠁿",apps:5, g:0,con:"2030",  wc:null,   st:"CORE (also covers DM/RB)",sc:"green"},
  {name:"L. Bergvall",    pos:"CM",e:"🇸🇪",apps:4, g:0,con:"2031",  wc:null,   st:"REQUESTED — FOREST BID REJ.",sc:"red"},
  {name:"C. Gallagher",   pos:"CM",e:"🏴󠁧󠁢󠁥󠁮󠁧󠁿",apps:3, g:1,con:"2031",  wc:null,   st:"CORE",                 sc:"green"},
  {name:"R. Bentancur",   pos:"DM",e:"🇺🇾",apps:6, g:0,con:"2029",  wc:"URU",  st:"NEW CONTRACT — SIGNED OCT '25, STAYS (also covers CM)",sc:"green"},
  {name:"S. Tonali",      pos:"DM",e:"🇮🇹",apps:4, g:0,con:"TBC",   wc:null,   st:"NEW — £100m RECORD, 6YR (reported)", sc:"cyan"},
  {name:"J. Maddison",    pos:"AM",e:"🏴󠁧󠁢󠁥󠁮󠁧󠁿",apps:3, g:0,con:"2028",  wc:null,   st:"AVAILABLE MD1",          sc:"green"},
  {name:"X. Simons",      pos:"AM",e:"🇳🇱",apps:0, g:0,con:"2030",  wc:null,   st:"ACL — FEB 2027",       sc:"red"},
  {name:"M. Fernandes",   pos:"AM",e:"🇵🇹",apps:6, g:0,con:"TBC",   wc:null,   st:"NEW — AVAILABLE MD1",    sc:"cyan"},
  // FORWARDS
  {name:"D. Kulusevski",  pos:"RW",e:"🇸🇪",apps:0, g:0,con:"2028",  wc:null,   st:"AVAILABLE — FITNESS MONITORED",sc:"green"},
  {name:"M. Kudus",       pos:"RW",e:"🇬🇭",apps:4, g:0,con:"2031",  wc:null,   st:"AVAILABLE — STARTED AT LIVERPOOL 15 SEP",sc:"green"},
  {name:"M. Tel",         pos:"LW",e:"🇫🇷",apps:6, g:0,con:"2031",  wc:null,   st:"PERMANENT — CORE (£30m, signed Jun '25)",sc:"green"},
  {name:"W. Odobert",     pos:"LW",e:"🇫🇷",apps:0, g:0,con:"2029",  wc:null,   st:"ACL — NOV 2026 (return needs re-check)",sc:"red"},
  {name:"D. Solanke",     pos:"ST",e:"🏴󠁧󠁢󠁥󠁮󠁧󠁿",apps:6, g:1,con:"2030",  wc:null,   st:"AVAILABLE MD1",          sc:"green"},
];
