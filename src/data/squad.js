...
export const SQUAD = [
  ...
  // DEFENDERS
  {name:"JP van Hecke",   pos:"CB",e:"🇳🇱",apps:2, g:0,con:"2031",  wc:"NED",  st:"NEW — €52m 5YR",       sc:"cyan"},
  ...
  // MIDFIELDERS
  {name:"A. Gray",        pos:"CM",e:"🏴󠁧󠁢󠁥󠁮󠁧󠁿",apps:2, g:0,con:"2030",  wc:null,   st:"CORE (also covers DM/RB)",sc:"green"},
  ...
  {name:"R. Bentancur",   pos:"DM",e:"🇺🇾",apps:2, g:0,con:"2029",  wc:"URU",  st:"NEW CONTRACT — SIGNED OCT '25, STAYS (also covers CM)",sc:"green"},
  {name:"S. Tonali",      pos:"DM",e:"🇮🇹",apps:2, g:0,con:"TBC",   wc:null,   st:"NEW — £100m RECORD, 6YR (reported)", sc:"cyan"},
  ...
  {name:"M. Fernandes",   pos:"AM",e:"🇵🇹",apps:2, g:0,con:"TBC",   wc:null,   st:"NEW — AVAILABLE MD1",    sc:"cyan"},
  // FORWARDS
  {name:"D. Kulusevski",  pos:"RW",e:"🇸🇪",apps:0,g:0,con:"2028",  wc:null,   st:"AVAILABLE — FITNESS MONITORED",sc:"green"},
  {name:"M. Kudus",       pos:"RW",e:"🇬🇭",apps:1, g:0,con:"2031",  wc:null,   st:"BACK IN TRAINING — Aug 22",sc:"green"},
